...
"++++++++++++++++++++ YCM For Rust config++++++++++++++++++++
"install ycm step:
" 1. sudo apt install build-essential cmake python3-dev libclang1
" 2. rustup toolchain install nightly
" 3. rustup default nightly
" 4. rustup component add rls
" 5. rustup component add rust-src
" 5. rustup component add rust-analysis
" 4. add Plugin "ycm-core/YouCompleteMe"
" 5. cd ~/.vim/bundle/YouCompleteMe
" 6. git submodule update --init --recursive
" 7. sudo apt install libclang-dev -y
" 8. ./install.py --clang-completer --system-libclang
" 9. config .vim.rc file
" 10. cd ~/.vim/bundle/YouCompleteMe
" 11. modify ycmd/rust-completer and let it support user-installed RLS(sed -i )
